...
- (void)setup
{
    ...
    self.font = [UIFont systemFontOfSize:kChatTextFontSize]; //TCOTS CHAT FONT SIZE;
...
//        else
//        {
//            [self.placeHolder drawInRect:<#(CGRect)#> withAttributes:<#(NSDictionary *)#>:placeHolderRect
//                                withFont:self.font
