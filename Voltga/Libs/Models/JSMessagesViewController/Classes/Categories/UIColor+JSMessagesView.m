...
+ (UIColor *)js_inputViewBGColor
{
    return [UIColor colorWithRed:0 green:0.56f blue:0.937f alpha:1.0f];
}

+ (UIColor *)js_inputTextViewBGColor
{
    return [UIColor colorWithRed:0 green:0.4375f blue:0.75f alpha:1.0f];
}
